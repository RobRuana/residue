...
def test_fingerprint_sql():
    assert fingerprint_sql("select * from user where name = 'Foo    Bar'") == 'b23bfc4cc7ad535ba6463473669f6597'
...
def test_check_constraint_naming_convention():
    ...
    assert check_constraint_naming_convention(constraint, table) == '82ae7c7955635a85bb8ae76bf656a878'
